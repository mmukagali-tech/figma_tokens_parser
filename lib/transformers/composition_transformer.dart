...
CompositionToken(
  ...
  String? _getPadding(Map<String, dynamic> values) {
    ...
    final horizontalPadding = DimensionValue.maybeParse(values['horizontalPadding']);
    final verticalPadding = DimensionValue.maybeParse(values['verticalPadding']);

    final topPadding = DimensionValue.maybeParse(values['paddingTop']) ?? verticalPadding ?? zero;
    final rightPadding =
        DimensionValue.maybeParse(values['paddingRight']) ?? horizontalPadding ?? zero;
    final bottomPadding =
        DimensionValue.maybeParse(values['paddingBottom']) ?? verticalPadding ?? zero;
    final leftPadding =
        DimensionValue.maybeParse(values['paddingLeft']) ?? horizontalPadding ?? zero;
...
padding: const EdgeInsets.only(
  ...
  String? _getBorderRadius(Map<String, dynamic> values) {
    ...
    final borderRadiusTopLeft = DimensionValue.maybeParse(values['borderRadiusTopLeft']);
    final borderRadiusTopRight = DimensionValue.maybeParse(values['borderRadiusTopRight']);
    final borderRadiusBottomRight = DimensionValue.maybeParse(values['borderRadiusBottomRight']);
    final borderRadiusBottomLeft = DimensionValue.maybeParse(values['borderRadiusBottomLeft']);
