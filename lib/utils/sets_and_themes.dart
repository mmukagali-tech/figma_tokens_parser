...
List<TokenTheme> getThemesFromJson(Map<String, dynamic> input) {
  ...
  // TODO: Сейчас в файле $themes.json много ненужных тем которые ломают парсер. Поэтому добавлен фильтр
  themes.removeWhere((e) => (e as Map<String, dynamic>)['group'] != 'app/mode');
