...
void main() {
  test('border radius token - single value', () {
    final token1 = Token(value: '0', type: 'borderRadius', name: 'zero', path: '');
    final token2 = Token(value: '16', type: 'borderRadius', name: 'medium', path: '');
  ...
  test('border radius token - double value', () {
    final token1 = Token(value: '16 2rem', type: 'borderRadius', name: 'zero', path: '');
    final output =
  ...
  test('border radius token - 4 values', () {
    final token1 = Token(value: '1 2 3 4', type: 'borderRadius', name: 'zero', path: '');
    final output =
